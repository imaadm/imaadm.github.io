...
function Banner(props) {
  return (
    <div className=" bg-indigo-400 py-4 sm:py-4 med:py-4 lg:py-8 ">
      <div className="flex flex-row justify-center max-w-[100%] gap-4 sm:gap-12 med:gap-24 lg:gap-24 py-4 sm:py-4 med:py-4 lg:py-8 ">
        ...
        {/* <img className="max-h-12 hidden sm:hidden med:max-h-24 med:visible lg:max-h-24 lg:visible" src={html} alt="htmllogo"></img>
        <img className="max-h-12 hidden sm:hidden med:max-h-24 med:visible lg:max-h-24 lg:visible" src={css} alt="cssjavalogo"></img> */}
